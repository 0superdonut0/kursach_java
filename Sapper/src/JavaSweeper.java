...
private int COLS=10; //сколько у нас будет столбцов
private int ROWS=10; //сколько будет строк
private int BOMBS=15; //сколько будет бомб
...
@Override
protected void
paintComponent(Graphics g) { //переопределяем метод пейнткомпонент
